...
SMTP_PORT = 465
SMTP_USER = 'everdeen40500@gmail.com'
SMTP_PASSWORD = 'damar802..'
...
# 엑셀 파일의 정보를 읽어올 수 있는 모듈import하세요.
# from openpyxl import load_workbook <- 이거 적고 저장했는데 위로 올라가버렸음
...
# send_mail('mark', 'everdeen40500@gmail.com', '자동화메일입니다.', contents, 'test.txt')
# def send_mail(name, addr, subject, contents, attachment=None):
send_mail('chobora', addr, '자동화메일입니다', contents, 'email_list.xlsx')
